...
architecture Behavioral of audio_meter_top is
    ...
    signal data_out_aku : STD_LOGIC_VECTOR(7 downto 0);  -- G_BITS=8
    signal spl_val_int  : STD_LOGIC_VECTOR(6 downto 0);
    signal led_data_int : STD_LOGIC_VECTOR(15 downto 0);

begin

    clk_divider : clock_divider
        generic map (G_DIV => 33)          -- 100MHz/33 = 3.03MHz PDM clock
        port map (
            clk    => clk,
            rst    => rst,
            clk_en => clk_en_div
